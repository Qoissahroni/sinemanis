        ...
        <div class="col-md-8">
                    ...
                    <form action="{{ route('user.profile.update') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 text-center mb-4 mb-md-0">
                                ...
                                <h5>{{ $user->name }}</h5>
                                <p class="text-muted">Calon Mahasiswa</p>
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="role" value="Calon Mahasiswa" disabled readonly>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('user.profile.password') }}" class="btn btn-outline-primary">
